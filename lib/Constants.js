...
export const SCHEMA = {
   ...
   get Setting() {
      return {
         ...
         slowMode: false,
         typingPresence: true,
         botInstruction: 'You\'re Alxena AI, a smart WhatsApp assistant by Starfall Co. Ltd.\n\nTalk like a chill, friendly friend, not formal, not robotic. Keep replies short, clear, and straight to the point.\n\nUse casual, natural English. Stay helpful, quick, and easy to talk to.\n\nMake every interaction feel smooth, simple, and effortless.',
         botModel: '',
         menuMessage: 'HAI NAMA SAYA ADALAH *Alxena*\nBOT INI DAPAT DIGUNAKAN SEBAGAI *TOOLS, INFO, STIKER, MEDIA DOWNLOADER, PENJAGA GRUP, DAN LAINNYA* YANG DAPAT MEMBUAT KAMU LEBIH MUDAH UNTUK MENJALANI HARI-HARI',
         newsletterId: '',
